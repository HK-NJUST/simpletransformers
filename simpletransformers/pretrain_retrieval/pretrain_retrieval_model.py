...
from simpletransformers.pretrain_retrieval.pretrain_retrieval_utils import (
...
class PretrainRetrievalModel:
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes a PretrainRetrievalModel model.
            ...
            for step, batch in enumerate(batch_iterator):
                ...
                if show_running_loss:
                    ...
                    description_str = (
                        ...
                        + length_loss_str
                        + correct_count_str
                        + average_span_length_str
                    )
                    batch_iterator.set_description(description_str)
    ...
    def _calculate_loss(
        ...
        query_outputs = query_model(**query_inputs).pooler_output  # pooler_output
